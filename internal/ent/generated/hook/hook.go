...
// The ResourceProviderFunc type is an adapter to allow the use of ordinary
// function as ResourceProvider mutator.
type ResourceProviderFunc func(context.Context, *generated.ResourceProviderMutation) (generated.Value, error)

// Mutate calls f(ctx, m).
func (f ResourceProviderFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
	if mv, ok := m.(*generated.ResourceProviderMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *generated.ResourceProviderMutation", m)
}
