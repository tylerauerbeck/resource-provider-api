...
import (
	...
	dbm "go.infratographer.com/resource-provider-api/db"
	"go.infratographer.com/resource-provider-api/internal/config"
)

const appName = "resource-provider-api"
...
var rootCmd = &cobra.Command{
	Use:   appName,
	Short: "A graph api for Resource Provider API",
}
...
func initConfig() {
	...
	viper.SetEnvPrefix("resourceproviderapi")
